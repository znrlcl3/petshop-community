...
public class SecurityConfig {
    ...
    @Bean
    public PasswordEncoder passwordEncoder() {  // ← 이 빈이 필요!
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests(auth -> auth
            .requestMatchers("/*.html", "/css/**", "/js/**", "/images/**").permitAll()  // ← 추가
...
//                
//                // 공개 페이지 허용
//                .requestMatchers("/", "/home", "/login", "/signup", "/board/*/list", "/board/*/view/*").permitAll()
